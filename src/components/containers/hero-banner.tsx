...
export const HeroBanner = () => {
	return (
		<section className='pt-6 bg-theme-blue-dark-intro relative md:pt-12'>
			...
			<section className='grid relative z-10'>
				<h1 className='font-raleway text-[24px] leading-9 font-bold text-center w-[320px] mx-auto mt-[33px] md:mt-[35px] md:text-[40px] md:leading-[60px] md:w-[734px]'>
					All your files in one secure location, accessible anywhere.
				</h1>
				<section className='grid'>
					<p className='text-[14px] leading-[21px] text-center w-[296px] mx-auto mt-[15px] md:w-[589px] md:text-[20px] md:mt-[33px] md:leading-[30px]'>
